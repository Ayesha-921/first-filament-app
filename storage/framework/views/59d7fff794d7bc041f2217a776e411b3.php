<?php $__env->startSection('title', 'MyShop — Online Shopping for Electronics, Clothing & More'); ?>
...
<div class="hero-slider" id="heroSlider">
    ...
    <div class="hero-slide hero-slide-1 active">
        <div class="hero-dots">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($d=0;$d<25;$d++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?><span></span><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-btns">
                    ...
                    <a href="<?php echo e(route('store.register')); ?>" class="btn-outline">
            ...
            <div class="hero-visual">
                ...
                <div class="hero-thumbs">
                    <a href="<?php echo e(route('products.index')); ?>" class="hero-thumb">
    ...
    <div class="hero-slide hero-slide-2">
        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-btns">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-primary" style="background:#4db8ff;box-shadow:0 4px 20px rgba(77,184,255,.35);">
                    ...
                    <a href="<?php echo e(route('products.index', ['sort'=>'latest'])); ?>" class="btn-outline">
                        New Arrivals &rsaquo;
                    </a>
                </div>
                <div class="hero-stats">
    ...
    <div class="hero-slide hero-slide-3">
        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-btns">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-primary" style="background:#00e096;color:#0a2018;box-shadow:0 4px 20px rgba(0,224,150,.3);">
    ...
    <div class="hero-slide hero-slide-4">
        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-btns">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-primary" style="background:#ffb400;color:#1a0f00;box-shadow:0 4px 20px rgba(255,180,0,.35);">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-outline">View Collections &rsaquo;</a>
                </div>
                <div class="hero-stats">
                    <div class="hero-stat">
    ...
    <div class="hero-slide hero-slide-5">
        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-btns">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-primary" style="background:#ff4444;color:#fff;box-shadow:0 4px 20px rgba(255,60,60,.35);">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="btn-outline">View All Gear &rsaquo;</a>
                </div>
                <div class="hero-stats">
                    <div class="hero-stat">
...
<div class="section">
    <div class="section-header">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="section-link">See all categories &rsaquo;</a>
    </div>
    <div class="cat-grid">
        <?php
        $catSvgs = [
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <a href="<?php echo e(route('products.index', ['category' => $cat->id])); ?>" class="cat-card">
                <div class="cat-icon"><?php echo $catSvgs[$cat->name] ?? $defaultSvg; ?></div>
...
<div class="deal-wrap">
    <div style="max-width:1240px;margin:0 auto;padding:0 16px;">
        <div class="deal-banner">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="deal-banner-btn">See all deals &rsaquo;</a>
        </div>
        <div class="product-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                ...
                <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="product-card">
                    <div class="product-card-img">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($thumb): ?>
                            <img src="<?php echo e($thumb); ?>" alt="<?php echo e($product->name); ?>" loading="lazy" />
                        <?php else: ?>
                    ...
                    <div class="product-card-body">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->brand): ?>
                            <div class="product-card-brand"><?php echo e($product->brand->name); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="product-card-price">$<?php echo e(number_format($product->price, 2)); ?></div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latest->isNotEmpty()): ?>
<div class="section">
    <div class="section-header">
        <h2 class="section-title">New Arrivals</h2>
        <a href="<?php echo e(route('products.index')); ?>" class="section-link">See all &rsaquo;</a>
    </div>
    <div class="product-grid">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $latest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <?php
                $imgs = collect($product->images ?? [])->filter()->values();
                $thumb = $imgs->first() ? \Illuminate\Support\Facades\Storage::url($imgs->first()) : null;
            ?>
    ...
    <div style="max-width:1240px;margin:0 auto;padding:0 16px;">
        ...
        <div class="brand-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="<?php echo e(route('products.index', ['brand' => $brand->id])); ?>" class="brand-chip"><?php echo e($brand->name); ?></a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
    </div>
</div>
...
<?php echo $__env->make('store.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\github-repository-data\first-filament-app\resources\views/store/home.blade.php ENDPATH**/ ?>