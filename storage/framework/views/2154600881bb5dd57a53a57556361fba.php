...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MyShop'); ?> — Professional Store</title>
    <style>
...
<div class="nav-top">
    ...
    <a href="<?php echo e(route('home')); ?>" class="nav-logo">My<span>Shop</span></a>
    ...
    <div class="nav-search" id="searchWrap">
        <select class="nav-search-cat" id="searchCat">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Category::where('type','shop')->where('is_active',true)->take(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
    ...
    <div class="nav-right">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            ...
            <form method="POST" action="<?php echo e(route('store.logout')); ?>" style="display:inline;">
                <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            <a href="<?php echo e(route('store.login')); ?>" class="nav-btn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ccc" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                <div class="nav-btn-text">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="nav-btn">
        ...
        <a href="<?php echo e(route('cart.index')); ?>" class="nav-cart">
            ...
            <span class="nav-cart-count" id="cartCount"><?php echo e(session('cart') ? array_sum(array_column(session('cart'), 'quantity')) : '0'); ?></span>
...
<div class="cat-strip" id="catStripMain">
    ...
    <a href="<?php echo e(route('products.index', ['sort'=>'latest'])); ?>">Today's Deals</a>
    <a href="<?php echo e(route('electronics')); ?>" class="<?php echo e(request()->routeIs('electronics') ? 'active' : ''); ?>">Electronics</a>
    <a href="<?php echo e(route('products.index', ['sort'=>'latest'])); ?>">New Arrivals</a>
    <a href="<?php echo e(route('products.index', ['sort'=>'price_asc'])); ?>">Best Sellers</a>
    <a href="<?php echo e(route('products.index')); ?>">Customer Service</a>
    <a href="<?php echo e(route('products.index')); ?>" class="prime">
...
<div class="deals-strip">
    ...
    ?>
    <a href="<?php echo e(route('products.index', ['sort'=>'latest'])); ?>" class="<?php echo e(request()->routeIs('products.index') && !request()->anyFilled(['category','brand','q']) ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('coupons')); ?>" class="<?php echo e(request()->routeIs('coupons') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('renewed-deals')); ?>" class="<?php echo e(request()->routeIs('renewed-deals') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('outlet')); ?>" class="<?php echo e(request()->routeIs('outlet') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('myshop-resale')); ?>" class="<?php echo e(request()->routeIs('myshop-resale') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('local-deals')); ?>" class="<?php echo e(request()->routeIs('local-deals') ? 'active' : ''); ?>">
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
        Local Deals
    </a>
    <a href="<?php echo e(route('electronics')); ?>" class="<?php echo e(request()->routeIs('electronics') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('home-garden')); ?>" class="<?php echo e(request()->routeIs('home-garden') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('fashion')); ?>" class="<?php echo e(request()->routeIs('fashion') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('sports')); ?>" class="<?php echo e(request()->routeIs('sports') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('beauty')); ?>" class="<?php echo e(request()->routeIs('beauty') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('new-releases')); ?>" class="<?php echo e(request()->routeIs('new-releases') ? 'active' : ''); ?>">
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3z"/></svg>
        New Releases
    </a>
    <a href="<?php echo e(route('best-price')); ?>" class="<?php echo e(request()->routeIs('best-price') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('a-z-listings')); ?>" class="<?php echo e(request()->routeIs('a-z-listings') ? 'active' : ''); ?>">
...
<footer>
    ...
    <div class="footer-bot">
        ...
        <div>&copy; <?php echo e(date('Y')); ?> MyShop, Inc. All rights reserved.</div>
    </div>
</footer>
...
<?php /**PATH D:\github-repository-data\first-filament-app\resources\views/store/layout.blade.php ENDPATH**/ ?>